...
## ✔ O que foi praticado
- Aplicação de técnicas básicas de exploração em serviços vulneráveis
- Identificação e uso de credenciais fracas ou mal configuradas
- Enumeração aprimorada para localizar pontos de ataque
- Obtenção de acesso inicial por meio de exploits simples
- Raciocínio independente na análise de vulnerabilidades
- Reconhecimento de padrões comuns em falhas de segurança
